...
path_plots_stringtie <- "~/OneDrive - Charité - Universitätsmedizin Berlin/Schuelke_Lab/EG15_RNA_Seq/Brain_organoids/StringTie_TPM_outputs/plots"


##Load StringTie outputs

file_links_stringtie <- list.files(path= "~/OneDrive - Charité - Universitätsmedizin Berlin/Schuelke_Lab/EG15_RNA_Seq/Brain_organoids/StringTie_TPM_outputs" , pattern = "*.txt", full.names=T)
...
df_plot_treatment_vs_control <- df_plot_all_samples %>%
  ...
  ggline(df_plot_treatment_vs_control, x = "study_day", y = "THRA1", add = "mean_se",
          color = "Treatment") +
  scale_color_manual("", values = c("control"="#A2D2DB","T3_pulse" = "#E98A33")) +
...
ggsave("Treatment_over_time_THRA1.png" , device=png, dpi = 600, path = path_plots_stringtie, bg = "transparent", width = 20, height = 15, units = "cm" )
  ...
  ggline(df_plot_treatment_vs_control, x = "study_day", y = "THRA2", add = "mean_se",
          color = "Treatment") +
...
ggsave("Treatment_over_time_THRA2.png" , device=png, dpi = 600, path = path_plots_stringtie, bg = "transparent", width = 20, height = 15, units = "cm" )
  ...
  ggline(df_plot_treatment_vs_control, x = "study_day", y = "THRA", add = "mean_se",
          color = "Treatment") +
  scale_color_manual("", values = c("control"="#302B27","T3_pulse" = "#E98A33")) +
